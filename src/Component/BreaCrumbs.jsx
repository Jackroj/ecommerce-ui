import { toCamelCase } from "../utlis/helper";
            ...
            <ol role="list" className="flex items-center space-x-0.5">
                ...
                {path && <li>
                    <div className="flex items-center">
                        ...
                        <div className="-m-1">
                            <a href="#" className="p-1 ml-0.5 text-sm font-medium text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700" aria-current="page"> {toCamelCase(path)} </a>
                        </div>
                    </div>
                </li>}
            </ol>
